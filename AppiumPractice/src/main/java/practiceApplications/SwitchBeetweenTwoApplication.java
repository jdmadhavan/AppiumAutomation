...
public class SwitchBeetweenTwoApplication {
	...
	public static void main(String[] args) throws MalformedURLException, InterruptedException {
        ...
        System.out.println("Successfully sent Message to Madhavan");
        
        Thread.sleep(2000);
        
        driver.startActivity(new Activity("com.facebook.katana", "com.facebook.katana.LoginActivity"));
        System.out.println("succesfully navigate to facebook ");
        Thread.sleep(2000);
        driver.startActivity(new Activity("com.whatsapp", "com.whatsapp.HomeActivity"));
        
        System.out.println("succesfully navigate to Whatsapp again");
